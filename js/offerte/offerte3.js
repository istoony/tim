$( document ).ready(function() {
    ...
    function getOfferteDispositivi(response) {
        ...
        for(i = 0; i < arr.length; i++){
            out+= '<div class="col-md-3 promotiontile center-block"><a href="singolodevice.html?id='+ arr[i].dispositivo +'"><img class="img-responsive devicesize center-block" src="' + arr[i].path + '" alt="' + arr[i].nome +'"><h2 class="nomargintop">' + arr[i].nome + '</h2><h1 class="nomargintop description-red">' + arr[i].prezzoscontato + '</h1> </a></div>';
        }
