<?php
    ...
    if(isset($_GET['id']))
        ...
        return;
    $result = $conn->query("SELECT pianotariffario.nome AS nome, pianotariffario.chiamate AS chiamate, pianotariffario.messaggi AS messaggi, pianotariffario.internet AS internet, pianotariffario.id AS id, pianotariffario.prezzo AS prezzo, dispositivo.nome AS nomedevice, marcadispositivo.nome AS marca
